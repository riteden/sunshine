package com.example.riteden.sunshine.app.service;
...
/**
 * Created by riteden on 2016/4/6.
 */
public class SunshineService extends IntentService{
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, values);
            }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Uri return_rowID = this.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
